  ...
  const bip85Panel = !profile.capabilities.bip85
    ...
    : `<section class="supplemental-derivation span-three" id="bip85-panel" hidden>
        ...
        <div id="bip85-result" hidden>
          ...
          <div class="actions"><button id="open-bip85-wallet" class="secondary" type="button" aria-expanded="false" hidden>Show derived wallet</button><details id="bip85-recovery-source-menu" class="recovery-source-menu" hidden><summary>Use in Recover &amp; Back Up</summary><div class="recovery-source-menu-items" aria-label="Recover and back up destination"><button type="button" data-recovery-source="bip85" data-recovery-target="matcher">Wallet Matcher</button><button type="button" data-recovery-source="bip85" data-recovery-target="seedqr">SeedQR</button><button type="button" data-recovery-source="bip85" data-recovery-target="slip39">SLIP-39 shares</button><button type="button" data-recovery-source="bip85" data-recovery-target="shamir">CKD Shamir</button><button type="button" data-recovery-source="bip85" data-recovery-target="sskr">SSKR</button><button type="button" data-recovery-source="bip85" data-recovery-target="gordian-envelope">Seed Envelope</button><button type="button" data-recovery-source="bip85" data-recovery-target="codex32">Codex32</button></div></details></div>
