...
assertCanonicalWasmBindgenProducer(readFileSync(resolve(generated, 'recovery_shamir_wasm_bg.wasm')), 'Shamir WASM');
const gluePath = resolve(generated, 'recovery_shamir_wasm.js');
