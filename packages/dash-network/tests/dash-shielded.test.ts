...
const OFFICIAL_FIXED_JSON = JSON.stringify({
  ...
  fullViewingKey:
    '4c66f3082f8300045544e392f9c83394ab80180a3146eee090506544b414e12feb9db9dc54b0110925d7e7f11948d8dd0cc775c588f4ce22e17046f4d338e81073eab1a0268a2b75beef1d23230b8eccc28baa08eebd6abfc78627271f428608',
  incomingViewingKey:
...
describe('Dash Shielded display encoding', () => {
  it('matches the official Rust Bech32m output pin for the fixed-seed address', () => {
    const raw = hexToBytes('ee9f8174f92a3f035570ecbfe969aeb46f5e2f64ad69f78d34316c47ea38c2f0085b5788bebf478ce736a8');
  ...
  it('rejects malformed JSON, invalid lengths, and non-sequential rows at the TS boundary', () => {
    ...
    expect(() => buildDashShieldedResult(OFFICIAL_FIXED_JSON.replace('"index":0', '"index":1'), options)).toThrow(
      /non-sequential/u,
    );
  });
});
