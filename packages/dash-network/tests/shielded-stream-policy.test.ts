...
describe('Orchard stream snapshot consistency', () => {
  ...
  it.each([
    {
      name: 'an older partial tail after a full page',
      pages: [
        { count: 2048, height: 101n },
        { count: 1, height: 100n },
      ],
    },
    {
      name: 'an older empty successor after a partial page',
      pages: [
        { count: 1, height: 101n },
        { count: 0, height: 100n },
      ],
    ...
    {
      name: 'an older second terminal confirmation',
      pages: [
        { count: 0, height: 101n },
        { count: 0, height: 100n },
      ],
