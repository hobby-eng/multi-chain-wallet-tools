...
export const create_sskr_shares: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const create_sskr_shares_formatted: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const recover_sskr_shares: (a: number, b: number, c: number) => void;
export const recover_sskr_shares_formatted: (a: number, b: number, c: number, d: number) => void;
