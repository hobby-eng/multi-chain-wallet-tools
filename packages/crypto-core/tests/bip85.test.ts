...
import { deriveBip85Bip39, deriveBip85Hex, deriveBip85Wif, deriveBip85Xprv } from '../src/bip85.js';
...
describe('BIP85 official application vectors', () => {
  it('derives the English 12-word application', () => {
    ...
    expect(entropyToEnglishMnemonic(hexToBytes(result.entropyHex))).toBe(
