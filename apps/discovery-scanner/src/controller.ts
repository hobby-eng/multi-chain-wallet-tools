...
function scanConfig(snapshot: RecoveryInputSnapshot): RecoveryScanConfig {
  return {
    ...
    coinJoinExternalCount: parseInteger(snapshot.coinJoinExternalCount, 'CoinJoin/DIP9 external address count', 0),
    coinJoinInternalCount: parseInteger(snapshot.coinJoinInternalCount, 'CoinJoin/DIP9 internal address count', 0),
