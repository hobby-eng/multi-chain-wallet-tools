...
const installedEvoManifest = JSON.parse(
  readFileSync(resolve(root, 'node_modules/@dashevo/evo-sdk/package.json'), 'utf8'),
);
const installedWasmManifest = JSON.parse(
  readFileSync(resolve(root, 'node_modules/.pnpm/node_modules/@dashevo/wasm-sdk/package.json'), 'utf8'),
);
...
if (
  ...
  throw new Error('The viewer requires exact installed Dash Evo SDK and WASM SDK version 4.1.0.');
}
