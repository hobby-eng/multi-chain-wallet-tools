...
const P2PKH_SCRIPT_SIG =
  '47304402204fe4fc488c955f286c52c848ec7950b40ec476e1b434c6add686b474bdde09a902206222d291fd9da341408aa8a4720f5a6959997715a1ddf8187e75277b6bfcae7e012103c67d86944315838aea7ec80d390b5d09b91b62483370d4979da5ccf7a7df77a9';
...
describe.each(['bitcoin', 'dash'] as const)('%s transaction display details', (chain) => {
  it('labels a standard previous P2PKH signature without treating it as the current PSBT signature', () => {
    ...
    expect(result.signature).toBe(
      '304402204fe4fc488c955f286c52c848ec7950b40ec476e1b434c6add686b474bdde09a902206222d291fd9da341408aa8a4720f5a6959997715a1ddf8187e75277b6bfcae7e01',
    );
...
it('does not enrich a non-OP_RETURN output', () => {
  expect(
    describeOpReturn(hexToBytes('76a914000000000000000000000000000000000000000088ac'), 'bitcoin', 'mainnet'),
  ).toBeNull();
});
