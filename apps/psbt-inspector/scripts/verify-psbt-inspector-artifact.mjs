...
for (const marker of [
  ...
  'Transaction accounting', 'Signing commitments / transaction mutability', 'Sighash', 'RBF', 'Locktime', 'Current unsigned fee rate estimate', 'decoded previous transaction', 'Internally verified', 'Transaction ID', 'Virtual size', 'scriptPubKey ASM', 'Raw / advanced PSBT maps',
