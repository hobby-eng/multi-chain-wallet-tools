...
for (const marker of [
  ...
  'Transaction accounting', 'Signing commitments / transaction mutability', 'Sighash', 'RBF', 'Locktime', 'Fee / current unsigned size', 'Referenced previous output', 'Complete previous transaction', 'Previous transaction signature', 'Payload hex', 'Internally verified', 'Transaction ID', 'Virtual size', 'scriptPubKey ASM', 'Raw / advanced PSBT maps',
