...
| Wallet Activity Viewer | `apps/activity-viewer` | `dist/activity-viewer/Wallet_Activity_Viewer.html` | HTTPS enabled | Orchard viewing capability only; public addresses/Identity identifiers are non-secret; never mnemonic/spending key |
